                ...
                <?php while ($row = $result->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td>
                            <!-- Botón para editar -->
                            <button 
                                class="btn btn-warning btn-sm editar-carrera" 
                                data-bs-toggle="modal" 
                                data-bs-target="#editarModal"
                                data-id="<?= $row['id_carrera'] ?>"
                                data-nombre="<?= $row['nombre_carrera'] ?>">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </button>

                            <!-- Botón para eliminar -->
                            <a href="carrers.php?eliminar=<?= $row['id_carrera'] ?>" class="btn btn-danger btn-sm">
            ...
            <form method="POST" class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre_carrera" id="modal-nombre-carrera" class="form-control" required>
                    </div>
                </div>
